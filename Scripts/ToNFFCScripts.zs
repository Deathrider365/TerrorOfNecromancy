...
dmapdata script DarkRegion //start
{
	void run(int radius, int itemClass)
	{
		...
		while(true)
		{
			...
			if (power)
				darkness_bmp->Circle(0, Hero->X + 8 + 256, Hero->Y + 8 + 176, radius * power, 0, 1, 0, 0, 0, true, OP_OPAQUE);
			
			darkness_bmp->Blit(7, -2, 256 - Game->Scrolling[SCROLL_NX], 176 - Game->Scrolling[SCROLL_NY], 256, 176, 0, 0, 256, 176, 0, 0, 0, mode, 0, true);
