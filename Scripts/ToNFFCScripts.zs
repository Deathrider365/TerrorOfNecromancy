...
{	
	int COMPASS_BEEP = 69; 			//Set this to the SFX id you want to hear when you have the compass
	int COMPASS_SFX = 20; 			//Set this to the SFX id you want to hear when you have the compass
