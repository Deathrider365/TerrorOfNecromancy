...
CONFIG DIFFICULTY_VERYEASY_DAMAGE_MULTIPLIER = 1;
CONFIG DIFFICULTY_EASY_DAMAGE_MULTIPLIER = 1;
CONFIG DIFFICULTY_NORMAL_DAMAGE_MULTIPLIER = 1;
CONFIG DIFFICULTY_HARD_DAMAGE_MULTIPLIER = 1;
CONFIG DIFFICULTY_VERYHARD_DAMAGE_MULTIPLIER = 1;

// Enemy base damage multipliers
CONFIG DIFFICULTY_ENEMY_VERYEASY_DAMAGE_MULTIPLIER = 0.65;
...
CONFIG DIFFICULTY_ENEMY_VERYHARD_DAMAGE_MULTIPLIER = 1.35;

// Enemy base HP multipliers
CONFIG DIFFICULTY_ENEMY_VERYEASY_HP_MULTIPLIER = 0.75;
...
CONFIG DIFFICULTY_ENEMY_VERYEASY_STEP_MULTIPLIER = .9; // 0.8
CONFIG DIFFICULTY_ENEMY_EASY_STEP_MULTIPLIER = 1;     // 0.9
CONFIG DIFFICULTY_ENEMY_NORMAL_STEP_MULTIPLIER = 1;
CONFIG DIFFICULTY_ENEMY_HARD_STEP_MULTIPLIER = 1;     // 1.1
CONFIG DIFFICULTY_ENEMY_VERYHARD_STEP_MULTIPLIER = 1.1; // 1.2
...
const int __DITEM_DIFFICULTYOVERRIDE = 2;
...
void DifficultyGlobal_Update() {
   ...
   if (DifficultyGlobal[__DITEM_DIFFICULTYOVERRIDE]) {
      //<100 = temporary (1 frame) override
      if (DifficultyGlobal[__DITEM_DIFFICULTYOVERRIDE] < 100) {
         DifficultyGlobal[__DI_CURDIFFICULTY] = DifficultyGlobal[__DITEM_DIFFICULTYOVERRIDE] - 1;
         DifficultyGlobal[__DITEM_DIFFICULTYOVERRIDE] = 0;
      }
      //>100 = permanent override
      else if (DifficultyGlobal[__DITEM_DIFFICULTYOVERRIDE] > 100)
         DifficultyGlobal[__DI_CURDIFFICULTY] = DifficultyGlobal[__DITEM_DIFFICULTYOVERRIDE] - 101;
   }
...
int Difficulty_GetDifficulty() {
   if (DifficultyGlobal[__DITEM_DIFFICULTYOVERRIDE]) {
      //<100 = temporary (1 frame) override
      if (DifficultyGlobal[__DITEM_DIFFICULTYOVERRIDE] < 100)
         return DifficultyGlobal[__DITEM_DIFFICULTYOVERRIDE] - 1;

      //>100 = permanent override
      else if (DifficultyGlobal[__DITEM_DIFFICULTYOVERRIDE] > 100)
         return DifficultyGlobal[__DITEM_DIFFICULTYOVERRIDE] - 101;
   }
      ...
      if (perm) {
         ...
         // Turn on long term override
            ...
            if (diffLevel == -1)
               ...
               DifficultyGlobal[__DITEM_DIFFICULTYOVERRIDE] = 101 + diffLevel;
         ...
         DifficultyGlobal[__DITEM_DIFFICULTYOVERRIDE] = 1 + diffLevel;
