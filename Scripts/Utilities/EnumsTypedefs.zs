...
CONFIG ITEM_SWORD5 = 220;
CONFIG ITEM_SWORD6 = 144;
...
CONFIG ITEM_RING4 = 219;
CONFIG ITEM_RING5 = 145;
...
CONFIG ITEM_HEART_RING3 = 223;
CONFIG ITEM_HEART_RING4 = 224;
CONFIG ITEM_HEART_RING5 = 225;
CONFIG ITEM_MAGIC_RING1 = 115;
CONFIG ITEM_MAGIC_RING2 = 116;
CONFIG ITEM_MAGIC_RING3 = 117;
CONFIG ITEM_MAGIC_RING4 = 118;
CONFIG ITEM_MAGIC_RING5 = 221;
CONFIG ITEM_MAGIC_PICKUP = 222;
...
CONFIG ITEM_JEWEL_OF_MARRE = 171;
CONFIG ITEM_PIRATE_TOME = 177;
CONFIG ITEM_MYSTERIOUS_ZORA_CHARM = 178;
CONFIG ITEM_ANCIENT_TABLET_PIECE = 182;
CONFIG ITEM_LEVIATHAN_SCALE1 = 183;
CONFIG ITEM_LEVIATHAN_SCALE2 = 218;
...
CONFIG ITEM_SUMMUS_TABLET_SHARD_A = 182;
CONFIG ITEM_SUMMUS_TABLET_SHARD_B = 215;
CONFIG ITEM_SUMMUS_TABLET_SHARD_C = 216;
CONFIG ITEM_SUMMUS_TABLET_SHARD_D = 217;
...
CONFIG SPR_FLAME_WAX = 35;
CONFIG SPR_FLAME_OIL = 142;
CONFIG SPR_FLAME_INCENDIARY = 144;
CONFIG SPR_FLAME_HELLS = 146;
CONFIG SPR_FLAME_WAX2X2 = 141;
CONFIG SPR_FLAME_OIL2X2 = 143;
CONFIG SPR_FLAME_INCENDIARY2X2 = 145;
CONFIG SPR_FLAME_HELLS2X2 = 147;

CONFIG SPR_ENEMY_FLAME_WAX = 35;
CONFIG SPR_ENEMY_FLAME_OIL = 142;
CONFIG SPR_ENEMY_FLAME_INCENDIARY = 144;
CONFIG SPR_ENEMY_FLAME_HELLS = 146;
CONFIG SPR_ENEMY_FLAME_WAX2X2 = 141;
CONFIG SPR_ENEMY_FLAME_OIL2X2 = 143;
CONFIG SPR_ENEMY_FLAME_INCENDIARY2X2 = 145;
CONFIG SPR_ENEMY_FLAME_HELLS2X2 = 147;
...
CONFIG CR_MAGIC_RING_SHARDS = CR_CUSTOM10;   // 16
CONFIG CR_HEART_RING_SHARDS = CR_CUSTOM11;   // 17
...
int activeItemIDs[] = {
   ...
   IC_FARORESWIND, IC_NAYRUSLOVE,     IC_DINSFIRE,     IC_CUSTOM4,
...
CONFIG ENEMY_ZOMBIE_LV3 = 224;

CONFIG ENEMY_GHINI_SERVUS_SUMMON = 243;

CONFIG ENEMY_LEGIONNAIRE_LVL1 = 220;
CONFIG ENEMY_LEGIONNAIRE_LVL3 = 272;
